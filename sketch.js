...
function setup() {
	...
	rightEdge=createSprite(290,625,20,100,{isStatic:true});
	rightEdge.shapeColor="red";
	
	bottomEdge=createSprite(width/2,660,200,20,{isStatic:true});
	bottomEdge.shapeColor="red";

	 leftEdge=createSprite(510,625,20,100,{isStatic:true});
